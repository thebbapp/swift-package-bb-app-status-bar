...
let package = Package(
    ...
    products: [.library(name: "BbAppStatusBar", targets: ["BbAppStatusBar"])],
    dependencies: [
    ...
    targets: [
        .binaryTarget(
            name: "BbAppStatusBar",
            url:
                "https://github.com/thebbapp/swift-package-bb-app-status-bar/releases/download/v0.1.0/BbAppStatusBar.xcframework.zip",
            checksum: "1c3b243a47c9dfd3a7715195908fa8a8ca7f17bae342bb22c242b04358d0d355"
        )
    ],
